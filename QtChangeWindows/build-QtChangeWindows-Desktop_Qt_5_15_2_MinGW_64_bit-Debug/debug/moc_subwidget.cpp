...
#include <memory>
#include "../../QtChangeWindows/subwidget.h"
...
QT_MOC_LITERAL(3, 20, 12) // "mySignalParm"

    },
    "SubWidget\0mySignal\0\0mySignalParm"
};
...
void SubWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubWidget::mySignalParm)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SubWidget::mySignalParm(int _t1, QString _t2)
{
